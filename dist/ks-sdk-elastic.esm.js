...
import { MaxUint256, sqrt, Price, CurrencyAmount, Percent, TradeType, Fraction, validateAndParseAddress as validateAndParseAddress$1 } from '@kyberswap/ks-sdk-core';
import { defaultAbiCoder, Interface } from '@ethersproject/abi';
import { getCreate2Address } from '@ethersproject/address';
import { keccak256, pack } from '@ethersproject/solidity';
import invariant from 'tiny-invariant';
import { abi as abi$5 } from '@uniswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json';
...
var TICK_SPACINGS = (_TICK_SPACINGS = {}, _TICK_SPACINGS[FeeAmount.STABLE] = 1, _TICK_SPACINGS[FeeAmount.LOWEST] = 1, _TICK_SPACINGS[FeeAmount.LOW] = 8, _TICK_SPACINGS[FeeAmount.MEDIUM] = 60, _TICK_SPACINGS[FeeAmount.HIGH] = 200, _TICK_SPACINGS['50'] = 10, _TICK_SPACINGS);
...
var FullMath = /*#__PURE__*/function () {
  ...
  FullMath.getSmallerRootOfQuadEqn = function getSmallerRootOfQuadEqn(a, b, c) {
    ...
    var tmp3 = sqrt(JSBI.subtract(tmp1, tmp2));
...
var Pool = /*#__PURE__*/function () {
  ...
  function Pool(tokenA, tokenB, fee, sqrtRatioX96, liquidity, reinvestLiquidity, tickCurrent, ticks) {
    ...
    !(Number.isInteger(fee) && fee < 100000) ? process.env.NODE_ENV !== "production" ? invariant(false, 'FEE') : invariant(false) : void 0;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _context.abrupt("return", [CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, 0, tickCurrent, this.tickDataProvider)]);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              outputToken = zeroForOne ? this.token1 : this.token0;
              return _context2.abrupt("return", [CurrencyAmount.fromRawAmount(outputToken, JSBI.multiply(outputAmount, NEGATIVE_ONE)), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, baseL, reinvestL, tickCurrent, this.tickDataProvider)]);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              return _context3.abrupt("return", [CurrencyAmount.fromRawAmount(inputToken, inputAmount), new Pool(this.token0, this.token1, this.fee, sqrtRatioX96, liquidity, 0, tickCurrent, this.tickDataProvider)]);
...
var validateAndParseAddress = function validateAndParseAddress(address) {
  return validateAndParseAddress$1(address);
};
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, ticks, options) {
    ...
    if (isMint(options) && options.createPool) {
      !(positions.length === 1) ? process.env.NODE_ENV !== "production" ? invariant(false, 'CREATE_POOL_ONLY_ACCEPT_ONE_POSITION') : invariant(false) : void 0;
    }

    var ticksPrevious = Array.isArray(ticks[0]) ? ticks : [ticks];
    !(positions.length === ticksPrevious.length) ? process.env.NODE_ENV !== "production" ? invariant(false, 'POSITIONS_AND_TICK_PREVIOUS_NOT_SAME_SIZE') : invariant(false) : void 0;
    positions.forEach(function (p) {
      !JSBI.greaterThan(p.liquidity, ZERO) ? process.env.NODE_ENV !== "production" ? invariant(false, 'ZERO_LIQUIDITY') : invariant(false) : void 0;
    });
    var calldatas = [];
    ...
    positions.forEach(function (p, index) {
      ...
      if (options.useNative) {
        ...
        !(p.pool.token0.equals(wrapped) || p.pool.token1.equals(wrapped)) ? process.env.NODE_ENV !== "production" ? invariant(false, 'NO_WETH') : invariant(false) : void 0;
...
SwapQuoter.INTERFACE = /*#__PURE__*/new Interface(abi$3);
...
SelfPermit.INTERFACE = /*#__PURE__*/new Interface(abi$5);
...
SwapRouter.INTERFACE = /*#__PURE__*/new Interface(abi$4);

export { ADDRESS_ZERO, FACTORY_ADDRESS, FeeAmount, FullMath, LiquidityMath, MIN_LIQUIDITY, Multicall, NoTickDataProvider, NonfungiblePositionManager, POOL_INIT_CODE_HASH, Payments, Pool, Position, Route, SelfPermit, SqrtPriceMath, SwapQuoter, SwapRouter, TICK_SPACINGS, Tick, TickList, TickListDataProvider, TickMath, Trade, computePoolAddress, encodeRouteToPath, encodeSqrtRatioX96, isSorted, maxLiquidityForAmounts, mostSignificantBit, nearestUsableTick, priceToClosestTick, tickToPrice, toHex };
//# sourceMappingURL=ks-sdk-elastic.esm.js.map
