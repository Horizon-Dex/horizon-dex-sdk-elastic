...
export declare abstract class NonfungiblePositionManager {
    ...
    static createCallParametersTest(pool: Pool, ethAmount: JSBI): MethodParameters;
    static addCallParameters(position: Position | Position[], ticks: number[] | number[][], options: AddLiquidityOptions): MethodParameters;
