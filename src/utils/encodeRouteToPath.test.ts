...
describe('#encodeRouteToPath', () => {
  ...
  const pool_0_1_medium = new Pool(token0, token1, FeeAmount.MOST_PAIR2, encodeSqrtRatioX96(1, 1), 0, 0, 0, [])
  const pool_1_2_low = new Pool(token1, token2, FeeAmount.STABLE, encodeSqrtRatioX96(1, 1), 0, 0, 0, [])
  const pool_0_weth = new Pool(token0, weth, FeeAmount.MOST_PAIR2, encodeSqrtRatioX96(1, 1), 0, 0, 0, [])
  const pool_1_weth = new Pool(token1, weth, FeeAmount.MOST_PAIR2, encodeSqrtRatioX96(1, 1), 0, 0, 0, [])
